...
const USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x1209,                 // Vendor ID //Freevid from pidcodes
    0x7787,                 // Product ID: TruePosition GPSDO Controller
...
{'w','w','w','.','C','i','r','c','u','i','t','V','a','l','l','e','y','.','c','o','m'
}};
...
{'C','V',' ','T','r','u','e','P','o','s','i','t','i','o','n',' ','G','P','S','D','O'}
};
